-- This lists all shows & linked genres from the database hbtn_0d_tvshows
   -- If the show doesn’t have a genre, display NULL in the genre column
   -- Each record should display:
      -- tv_shows.title - tv_genres.name
   -- The results must be sorted in ascending order by the show title and genre
